...
class Loader(BasicDataset):
    ...
    def __init__(self, config=world.config, path="../data/gowalla"):
        raise NotImplementedError("Use home kit for this project.")
...
class Home_Kit(BasicDataset):
    """
    Dataset for NTS Home_and_Kitchen domains.
    ...
    def __init__(self, config=world.config, path=None):
        if path is None:
            raise ValueError("path must be provided for Home_Kit")
        cprint(f'loading Home_and_Kitchen [{path}]')
